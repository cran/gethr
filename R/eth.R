...
#' @param gas Integer - Gas provided for the call execution. \code{eth_call}
...
#' @param data Data - Hash of the method signature and encoded parameters. For
#'   details see Ethereum Contract ABI
#'   \url{https://solidity.readthedocs.io/en/develop/abi-spec.html}.
#' @param number Integer|Tag - Integer block number, or the string 'latest',
...
#' @param number Integer|Tag - Block number, or the string 'latest', 'earliest'
#'   or 'pending'.
#'
...
#' @param full Boolean - If \code{true} it returns the full transaction objects,
...
#'
#' \code{eth_getBlockByNumber} returns information about a block by block
#' number.
#'
#' @family eth functions
#'
...
#'
#' \code{eth_getBlockTransactionCountByHash} returns the number of transactions
#' in a block from a block matching the given block hash.
#'
#' @family eth functions
#'
#' @param hash Hash - Hash of the block.
...
#' @examples
#' \donttest{
#' eth_getBlockTransactionCountByHash('0x6e4670b7fda89b5960e684d4c809f7e7e9d9c0
#' ee70b43849405efe78aa3c0d24')
#' }
#'
#' @export
...
#'
#' \code{eth_getBlockTransactionCountByNumber} returns the number of
#' transactions in a block from a block matching the given block number.
#'
#' @family eth functions
#'
...
#' Filter information.
#'
#' \code{eth_getFilterLogs} returns an array of all logs matching filter with
#' given id.
#'
#' @family eth functions
#'
...
#' @family eth functions
#'
#' @param from_block Integer|Tag - Block number, or the string 'earliest',
#'   'latest' or 'pending'.
#' @param to_block Integer|Tag - Block number, or the string 'earliest',
#'   'latest' or 'pending'.
#' @param address Address - Contract address or a list of addresses from which
#'   logs should originate.
#' @param topics Array of Data - Topics are order-dependent. Each topic can also
#'   be an array of DATA with 'or' options.
#' @param block_hash Hash Single block to return logs. If \code{blockHash} is
...
#' @param keys Array of Data - Storage-keys which should be proofed and
#'   included.
#' @param number Integer|Tag - Block number, or the string 'latest', 'earliest'
#'   or 'pending'.
#'
...
#'
#' \code{eth_getTransactionByBlockHashAndIndex} returns information about a
#' transaction by block number and transaction index position.
#'
#' @family eth functions
#'
#' @param block_number Integer|Tag - Block number, or the string 'earliest',
#'   'latest' or 'pending'.
#' @param trans_index Integer - Transaction index position.
#' @param hex Boolean - \code{true} to get the response in hexadecimal,
#'   \code{false} to get a readable response.
...
#'
#' \code{eth_getTransactionCount} returns the number of transactions sent from
#' an address.
#'
#' @family eth functions
#'
...
#'   \code{false} to get a readable response.
#'
#' @return Object - A transaction receipt, or \cite{null} when no receipt was
#'   found.
#'
#' @examples
#' \donttest{
...
#' @examples
#' \donttest{
#' eth_getUncleByBlockHashAndIndex('0xb69e76f3997f318f4385f31885576aa43cb40ad4ed
...
#'
#' \code{eth_getUncleCountByBlockHash} returns the number of uncles in a block
...
#'
#' \code{eth_hashrate} returns the number of hashes per second that the node is
#' mining with.
#'
#' @family eth functions
#'
...
#'
#' \code{eth_mining} returns \code{true} if client is actively mining new
#' blocks.
#'
#' @family eth functions
#'
#' @return Boolean - \code{true} if the client is mining, otherwise
#'   \code{false}.
#'
#' @examples
#' \donttest{
...
#' New block filter.
#'
#' \code{eth_newBlockFilter} creates a filter in the node, to notify when a new
#' block arrives.
#'
#' @family eth functions
#'
...
#' New filter.
#'
#' \code{eth_newFilter} creates a filter object, based on filter options, to
#' notify when the state changes (logs).
#'
#' @family eth functions
#'
#' @param from_block Integer|Tag - Block number, or the string 'earliest',
...
#'
#' \code{eth_newPendingTransactionFilter} creates a filter in the node, to
...
#'
#' @return Boolean - returns \code{true} if the provided solution is valid,
...
#' Sync status.
#'
#' \code{eth_syncing} returns an object with data about the sync status or
#' \code{false}.
#'
#' @family eth functions
#'
#' @return Object|Boolean - An object with sync status data or \code{false},
#'   when not syncing.
#'
#' @examples
#' \donttest{
...
#' Filter removal.
#'
#' \code{eth_uninstallFilter} uninstalls a filter with given id. Should always
#' be called when watch is no longer needed.
#'
#' @family eth functions
#'
#' @param id Integer - Filter Id.
#'
#' @return Boolean - \code{true} if the filter can be unistalled, otherwise
#'   \code{false}.
#'
#' @examples
#' \donttest{
